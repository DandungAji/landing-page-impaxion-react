      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
          ...
          <p className="text-gray-400 text-sm mb-8 text-center">
            Update rutin, backup, keamanan, dan perbaikan teknis kami tangani
            untukmu.
          </p>
          <div className="h-32 bg-dark-lighter rounded-lg flex items-end overflow-hidden">
            ...
            >
              <path
                d="M0,50 L10,45 L20,48 L30,40 L40,45 L50,35 L60,38 L70,30 L80,25 L90,20 L100,10"
                fill="none"
                stroke="#a1ff69"
                strokeWidth="2"
              />
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
          ...
          <p className="text-gray-400 text-sm mb-8 text-center">
            Desain modern & responsive. Cocok untuk bisnis, portofolio,
          ...
          <div className="h-32 bg-dark-lighter rounded-lg flex items-end overflow-hidden">
            ...
            >
              <path
                d="M0,40 L10,35 L20,45 L30,30 L40,35 L50,25 L60,40 L70,20 L80,30 L90,25 L100,20"
                fill="none"
                stroke="#6987ff"
                strokeWidth="2"
              />
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800 hover:border-gray-700 transition-all">
          ...
          <p className="text-gray-400 text-sm mb-8 text-center">
            Biar website kamu nggak cuma keren, tapi juga bikin pengunjung betah
            dan ngerti harus ngapain.
          </p>
          <div className="h-32 bg-dark-lighter rounded-lg flex items-center justify-center">
            <div className="flex -space-x-2">
              <img
                ...
                alt=""
                className="w-12 h-12 rounded-full border-2 border-dark-lighter"
              />
              <img
