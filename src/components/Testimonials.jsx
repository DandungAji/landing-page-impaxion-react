  ...
  return (
    <section className="max-w-6xl mx-auto px-6 mb-24">
      ...
      <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
        Pengguna dari berbagai industri telah membuktikan manfaat menggunakan
        layanan kami. Berikut adalah testimonial dari beberapa pengguna
        Impaxion.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800">
          <p className="text-gray-300 mb-6">
            "I really like the system of this application. I love recommending
            this software to you guys."
          </p>
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800">
          <p className="text-gray-300 mb-6">
            "We enjoy our experience with the services which is why our offering
            is becoming our referral."
          </p>
        ...
        <div className="bg-dark-light rounded-xl p-6 border border-gray-800">
          <p className="text-gray-300 mb-6">
            "I really like the system of this application. I love recommending
            this product to you guys."
          </p>

          <div className="flex items-center">
            <img
              src="https://i.pravatar.cc/48?img=41"
              alt="Avatar"
              className="w-12 h-12 rounded-full mr-3"
            />
            <div>
