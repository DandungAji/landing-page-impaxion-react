  ...
  return (
    <section className="max-w-6xl mx-auto px-6 mb-24 grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div className="flex flex-col justify-center">
        <h2 className="text-white text-3xl font-bold mb-4">Aplikasi Mobile Sesuai Kebutuhanmu</h2>
        <p className="text-gray-400 mb-8">
          Aplikasi mobile yang disesuaikan dengan kebutuhan bisnis Anda. Kontrol seluruh operasi bisnis dari genggaman Anda.
        </p>
      ...
      {/* Right Side */}
      <div className="flex flex-col justify-center">
        <h2 className="text-white text-3xl font-bold mb-4">Bingung Mulai?<br />Konsultasi Dulu Aja!</h2>
        <p className="text-gray-400 mb-8">
          Tim ahli kami siap membantu Anda menentukan solusi terbaik untuk kebutuhan bisnis Anda. Konsultasi gratis untuk setiap klien baru.
        </p>
