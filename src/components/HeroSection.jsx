  ...
  return (
    <section className="text-center px-6 py-20 max-w-4xl mx-auto relative">
      ...
      <div className="bg-primary text-black text-xs font-medium px-3 py-1 rounded-full inline-flex items-center mb-6">
        <span className="mr-2">Gratis Copywriting</span>
        <span className="bg-black text-primary rounded-full p-2 h-5 flex items-center justify-center text-xs">
          Baru
        </span>
      </div>
      ...
      <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
        Solusi kenyamanan untuk bisnis Anda. Lihat berbagai fitur yang kami
        tawarkan untuk memaksimalkan performa bisnis Anda.
      </p>
      ...
      <div className="flex justify-center">
        <div className="py-2 px-4 bg-dark-lighter rounded-full flex items-center gap-2 text-sm">
          <span className="text-gray-400">
            Digunakan oleh 20+ UMKM & Komunitas
          </span>
          <div className="flex -space-x-2">
            <img
              src="https://i.pravatar.cc/32?img=1"
              alt=""
              className="w-6 h-6 rounded-full ring-2 ring-dark-lighter"
            />
            <img
